...
public interface IStockTransferService
{
    ...
    Task<StockTransferRequestDto> AcceptAsync(long id, AcceptStockTransferRequestDto request, string userCode, CancellationToken ct = default);
    Task<StockTransferDispatchDto> DispatchAsync(long id, CreateStockTransferDispatchDto request, string userCode, CancellationToken ct = default);
