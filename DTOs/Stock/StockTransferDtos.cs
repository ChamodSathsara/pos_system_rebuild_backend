...
{
    public long TransferRequestId { get; set; } public string RequestNo { get; set; } = string.Empty; public string? LinkedPoNo { get; set; } public string SourceWarehouseCode { get; set; } = string.Empty; public string? SourceWarehouseName { get; set; } public string DestinationWarehouseCode { get; set; } = string.Empty; public string? DestinationWarehouseName { get; set; } public StockTransferStatus Status { get; set; } public DateTime RequestDate { get; set; } public DateTime? RequiredDate { get; set; } public string? Remarks { get; set; } public List<StockTransferRequestLineDto> Lines { get; set; } = []; public List<StockTransferDispatchDto> Dispatches { get; set; } = [];
}
...
public class StockTransferDispatchLineDto { public long DispatchLineId { get; set; } public long TransferRequestLineId { get; set; } public string ItemCode { get; set; } = string.Empty; public long BatchId { get; set; } public string? BatchNo { get; set; } public decimal Quantity { get; set; } public decimal UnitCost { get; set; } public decimal SellingPrice { get; set; } public DateOnly? ExpiryDate { get; set; } }
